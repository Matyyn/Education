...
function TeacherLayout({ children }) {
  ...
  return (
    <div className="flex">
      {showSidebar && <Sidebar />}
      <div className="flex flex-col pl-5 w-full gap-4 bg-light">
        <div className="pr-5 mt-3">
          <div className="shadow-nav bg-white flex justify-between w-full relative py-2 rounded-lg items-center gap-5 px-5 z-10">
            <img src={Hamburger} alt="hamburger" onClick={toggleSidebar} />
        ...
        <div className="min-h-[calc(100vh_-_100px)] mr-5">
          {children}
          <Outlet />
        </div>
      </div>
