                      ...
                      <tr key={index}>
                        ...
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <div className="flex justify-center">
                            <text className="flex items-center justify-center w-6 h-6 -mx-1 text-sm text-blue-600 bg-blue-100 border-2 border-white rounded-full">
                              {teacher.Role}
                            </text>
                          </div>
                        </td>
                        ...
                        <td className="px-12 py-4 text-sm font-medium whitespace-nowrap">
                          <div
                            className={`inline px-3 py-1 text-sm font-normal rounded-full gap-x-2 text-center ${
                              teacher.userStatus === "Deactivated"
                                ? "text-red-500"
                                : "text-emerald-500"
                            } ${
                              teacher.userStatus === "Deactivated"
