                      ...
                      <tr key={index}>
                        ...
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <div className="flex justify-center">
                            ...
                            <p className="flex items-center justify-center w-6 h-6 -mx-1 text-sm text-blue-600 bg-blue-100 border-2 border-white rounded-full">
                              +{teacher.teacherName.length}
                            </p>
                          </div>
                        </td>
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <div className="flex justify-center">
                            {teacher.studentsRegistered.map(
                            ...
                            <p className="flex items-center justify-center w-6 h-6 -mx-1 text-sm text-blue-600 bg-blue-100 border-2 border-white rounded-full">
                              +{teacher.studentsRegistered.length}
                            </p>
                          </div>
                        </td>
