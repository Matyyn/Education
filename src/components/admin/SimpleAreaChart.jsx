...
const LineChart = ({ option }) => {
  if (option === "1") {
    ...
    const containerClasses = "bg-white rounded-xl shadow-md";

    return (
      // <ResponsiveContainer width="100%" height="100%">
      <div
        className={containerClasses + " sm:w-full md:w-1/2 lg:w-1/3 xl:w-1/4"}
      >
        <div className="px-4">
    ...
    return (
      ...
      >
        <div className="px-4">
          <div style={{ justifyContent: "space-between" }} className="flex">
            <p className="font-semibold text-orange-300 py-2 px-2 w-10 h-10 align-middle bg-[#178582] rounded-full m-1 p-1 mb-2 text-sm">
              <img src={Grad} />
            </p>
            <FormControl sx={{ m: 1, minWidth: 70 }} size="small">
              <InputLabel id="demo-select-small-label">Weekly</InputLabel>
