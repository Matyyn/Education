    ...
    <>
      <div className="flex items-center justify-between mb-2">
        ...
        >
          ...
          <h1 className="text-md font-semibold text-black-600">Edit Profile</h1>
        </div>
      </div>
      <form
                ...
                <div>
                  <input
                    ...
                    className={`${errors.fullName ? "border-red-500" : ""} ${
                      field.isDisabled ? "opacity-75 cursor-not-allowed" : ""
              ...
              render={({ field }) => (
                <div>
                  <input
                    {...field}
                    id="dateJoined"
                    className={`${errors.dateJoined ? "border-red-500" : ""} ${
                      field.isDisabled ? "opacity-75 cursor-not-allowed" : ""
                    } w-full p-2 mt-1 rounded border border-gray-300 focus:outline-none focus:ring focus:border-blue-300`}
                    placeholder="3 June, 2023"
                    disabled={field.isDisabled}
                  />
                  {errors.dateJoined && (
                    <p className="text-red-500">{errors.dateJoined.message}</p>
                  )}
                </div>
              )}
            />
